package com.sinosoft.ilogrule.ilog.xom.undwrtXom.CarRule.util;
...
public class UtilXom {
	 ...
	 * @return
	 */
	public double sumItemKindAmountNotA(List<ItemKindXom> itemList){
		double sumAmount = 0;
		for(ItemKindXom itemKindXom:itemList){
			if(!"A".equals(itemKindXom.getItemKindCode())){//主险
				sumAmount = sumAmount + itemKindXom.getAmount();
			}
		}
		return sumAmount;
