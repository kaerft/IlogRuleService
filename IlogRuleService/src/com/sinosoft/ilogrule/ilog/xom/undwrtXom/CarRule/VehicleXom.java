...
public class VehicleXom{
	 ...
	 * 特殊车辆系数
	 */
	private double sspecialVehicle;
	/***
	 * 协商实际价值
	 */
	 ...
	 * 协商实际价值浮动比例
	 */
	private double actualFloatRatioValue;
	/***
	 * 是否节能减排车
	 */
	...
	public double getActualFloatRatioValue() {
		return actualFloatRatioValue;
	}

	public void setActualFloatRatioValue(double actualFloatRatioValue) {
	...
	public double getSspecialVehicle() {
		return sspecialVehicle;
	}

	public void setSspecialVehicle(double sspecialVehicle) {
	...
	public double getHfTaxValue() {
		return hfTaxValue;
	}

	public void setHfTaxValue(double hfTaxValue) {
