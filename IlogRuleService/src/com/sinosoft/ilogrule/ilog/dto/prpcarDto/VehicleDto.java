...
public class VehicleDto implements Serializable{
	...
	private String specialType_Code;	//特殊车辆类型代码
	
	private String specialType;	//特殊车辆类型名称
	
	private String specialValue;	//特殊车辆系数
	...
	private String loanFlag;	//是否贷款车

	private String carKindCode;	//车辆种类代码
	private String carKindName;	//车辆种类名称
	
	private String vehiclesClass_Code;	//车辆类别代码
	private String vehiclesClass;	//车辆类别名称
	...
	public String getSpecialType_Code() {
		return specialType_Code;
	}

	public void setSpecialType_Code(String specialType_Code) {
		this.specialType_Code = specialType_Code;
	}
	...
	public String getVehiclesClass_Code() {
		return vehiclesClass_Code;
	}

	public void setVehiclesClass_Code(String vehiclesClass_Code) {
		this.vehiclesClass_Code = vehiclesClass_Code;
	}

	public String getVehiclesClass() {
		return vehiclesClass;
	}

	public void setVehiclesClass(String vehiclesClass) {
		this.vehiclesClass = vehiclesClass;
	}
