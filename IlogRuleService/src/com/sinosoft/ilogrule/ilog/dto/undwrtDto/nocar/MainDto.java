...
public class MainDto implements Serializable{
	 ...
	 * 跟单保额的自留额
	 */
	private String polRetSumAmount;
	/***
	 * 跟单累计限额
	 */
	private String polSumLimit;
	/***
	 * 跟单每人限额
	 */
	private String polPerLimit;
	/***
	 * 跟单每次事故限额
	 */
	private String polPerAcciLimit;
	/***
	 * 跟单累计限额的自留额
	 */
	private String polRetSumLimit;
	/***
	 * 跟单每人限额的自留额
	 */
	private String polRetPerLimit;
	/***
	 * 跟单每次事故限额的自留额
	 */
	private String polRetPerAcciLimit;
	...
	public String getPolRetSumAmount() {
		return polRetSumAmount;
	}

	public void setPolRetSumAmount(String polRetSumAmount) {
		this.polRetSumAmount = polRetSumAmount;
	}

	public String getPolSumLimit() {
		return polSumLimit;
	}

	public void setPolSumLimit(String polSumLimit) {
		this.polSumLimit = polSumLimit;
	}

	public String getPolPerLimit() {
		return polPerLimit;
	}

	public void setPolPerLimit(String polPerLimit) {
		this.polPerLimit = polPerLimit;
	}

	public String getPolPerAcciLimit() {
		return polPerAcciLimit;
	}

	public void setPolPerAcciLimit(String polPerAcciLimit) {
		this.polPerAcciLimit = polPerAcciLimit;
	}

	public String getPolRetSumLimit() {
		return polRetSumLimit;
	}

	public void setPolRetSumLimit(String polRetSumLimit) {
		this.polRetSumLimit = polRetSumLimit;
	}

	public String getPolRetPerLimit() {
		return polRetPerLimit;
	}

	public void setPolRetPerLimit(String polRetPerLimit) {
		this.polRetPerLimit = polRetPerLimit;
	}

	public String getPolRetPerAcciLimit() {
		return polRetPerAcciLimit;
	}

	public void setPolRetPerAcciLimit(String polRetPerAcciLimit) {
