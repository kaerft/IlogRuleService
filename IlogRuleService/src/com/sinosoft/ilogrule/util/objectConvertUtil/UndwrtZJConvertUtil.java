...
import com.sinosoft.ilogrule.ilog.xom.undwrtXom.zjRule.ApplicantXom;
import com.sinosoft.ilogrule.ilog.xom.undwrtXom.zjRule.InsuredXom;
import com.sinosoft.ilogrule.ilog.xom.undwrtXom.zjRule.ItemKindXom;
import com.sinosoft.ilogrule.ilog.xom.undwrtXom.zjRule.MainXom;
import com.sinosoft.ilogrule.ilog.xom.undwrtXom.zjRule.OtherXom;
...
import com.sinosoft.ilogrule.ilog.xom.undwrtXom.zjRule.VehicleOwnerXom;
import com.sinosoft.ilogrule.ilog.xom.undwrtXom.zjRule.VehicleXom;
import com.sinosoft.ilogrule.ilog.xom.undwrtXom.zjRule.ZJDetailXom;
...
public class UndwrtZJConvertUtil {
	 ...
	 * @return
	 */
	public static UndwrtZJInputXOM ConvertObject(UndwrtZJInputDto undwrtInputDto,String saveLogId){
		UndwrtZJInputXOM undwrtInputXOM = new UndwrtZJInputXOM();
		undwrtInputXOM.setUndwrtZJResultXOM(new UndwrtZJResultXOM());
		try {
			...
			if(undwrtInputDto.getVehicleDto()!=null){	
				...
				if(PubTools.isNotNull(undwrtInputDto.getVehicleDto().getVehicleSpeciesCode())){
					...
					sb.append("VehicleDto.VehicleSpeciesCode为空|");
				}
				...
				if(PubTools.isNotNull(undwrtInputDto.getVehicleDto().getVehicleSpeciesName())){
					...
					sb.append("VehicleDto.VehicleSpeciesName为空|");
				}
			...
			//组织ZJDetailXom begin
			ZJDetailXom zjDetailXom = new ZJDetailXom();
			if(undwrtInputDto.getZjDetailDto()!=null){
				//String
				if(PubTools.isNotNull(undwrtInputDto.getZjDetailDto().getUndwrtGrade())){
					undwrtInputXOM.getUndwrtZJResultXOM().setUndwrtLevel(undwrtInputDto.getZjDetailDto().getUndwrtGrade());
				}else{
					sb.append("ZJDetailDto.UndwrtGrade为空|");
				}
			}else{
				sb.append("ZJDetailDto为空|");
			}
			undwrtInputXOM.setZjDetailXom(zjDetailXom);
			//组织ZJDetailXom end
			
			//组织UnderwriteResultXOM begin
			String strCheckRequ = sb.toString();
			undwrtInputXOM.getUndwrtZJResultXOM().setDescription(strCheckRequ);
			undwrtInputXOM.getUndwrtZJResultXOM().setUndwrtFlag("");
	 ...
	 * @return
	 */
	public static UndwrtZJResultDto ConvertObject(UndwrtZJResultXOM underwriteResultXOM){
		UndwrtZJResultDto underwriteResultDto = new UndwrtZJResultDto();
		try {
