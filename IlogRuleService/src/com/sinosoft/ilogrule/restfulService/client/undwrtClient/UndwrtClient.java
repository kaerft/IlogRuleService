...
import com.sinosoft.ilogrule.ilog.dto.undwrtDto.car.ApplicantDto;
import com.sinosoft.ilogrule.ilog.dto.undwrtDto.car.InsuredDto;
import com.sinosoft.ilogrule.ilog.dto.undwrtDto.car.ItemKindDto;
import com.sinosoft.ilogrule.ilog.dto.undwrtDto.car.MainDto;
import com.sinosoft.ilogrule.ilog.dto.undwrtDto.car.OtherDto;
...
import com.sinosoft.ilogrule.ilog.dto.undwrtDto.car.VehicleDto;
import com.sinosoft.ilogrule.ilog.dto.undwrtDto.car.VehicleOwnerDto;
import com.sinosoft.ilogrule.restfulService.client.baseClient.DealHeadInfo;
import com.sun.jersey.api.client.ClientResponse;
import com.sun.jersey.api.client.WebResource.Builder;

public class UndwrtClient {
	...
	public UnderwriteResultDto undwrtCarRule(UndwrtInputDto requestBody) throws Exception{
		...
		try{
			...
			//String url = "http://7.236.166.150:8026/IlogRuleService/rest/UndwrtRuleRestfulService/undwrtCarRule";
			//String url = "http://7.236.166.150:8027/IlogRuleService/rest/UndwrtRuleRestfulService/undwrtCarRule";
			String url = "http://localhost:7001/IlogRuleService/rest/UndwrtRuleRestfulService/undwrtCarRule";
	...
	public UndwrtInputDto organizeObject() {
		...
		//投保方式
		mainXom.setModeCode("专业代理");//非空 码表 191007 经纪业务
		//个/团单标识
...
//		mainXom.setStopTimes("");//可为空  
		//业务员代码
		mainXom.setHandler_Code("88000157");//非空
		...
		applicantXom.setCustomerChannel("市场业务");//非空 码表 加油站 中石油团车
		//投保人名称
		applicantXom.setAppliCode("201804C001489-");//非空
		applicantXom.setAppliName("大石桥市蟠龙汽车出租服务有限公司");//非空 霸州中石油昆仑燃气有限公司
		//投保人类型
		applicantXom.setInsuredNature_Code("0");//非空 码表
		applicantXom.setInsuredNature("个人");//非空 码表
		//投保人客户行业
...
//		applicantXom.setLinkerMobile("");//可为空
		...
		insuredXom.setInsuredNature("个人");//非空 码表
		//被保人客户行业
...
//		insuredXom.setLinkerMobile("");//可为空
		...
		vehicleXom.setBrandName("救护车");//非空
		// 车系
		...
		vehicleXom.setUsenature_Name("摩托车");//非空 码表
		// 营业性质
		...
		// 是否上牌
		vehicleXom.setIsOneCard("未上牌车辆");//非空
		// 车船税标志
		//vehicleXom.setHfName_Code("");//可为空 码表 交强有值
		//vehicleXom.setHfName("");//可为空 码表 交强有值
		// 车牌号
		vehicleXom.setLicenseNo("黑U12345");//非空 沪FQ0201 川U12345
		// 纳税类型
		...
		// 新车购置价
		vehicleXom.setPurchasePrice("100000");//非空
		// 车龄
		...
		vehicleXom.setIsNewCar("否");//非空 码表
		// 特殊车辆系数
		...
		// 险别保额
		itemKindXom.setAmount("10000000");//可为空
		// 上年投保是否出险
...
////		
		...
		// 险别保额
		itemKindXom3.setAmount("10000");//可为空
		// 上年投保是否出险
...
//		
		...
		// 险别保额
		itemKindXom7.setAmount("10000000");//可为空
		// 上年投保是否出险
...
//		
		...
		// 险别保额
		itemKindXom10.setAmount("61000000");//可为空
		// 上年投保是否出险
		...
		//主附险标志
		itemKindXom10.setFlag("2");
		itemKindXomList.add(itemKindXom10);
		
//		ItemKindDto itemKindXom11 = new ItemKindDto();
//		// 险别
//		itemKindXom11.setItemKindCode("E");//非空 码表
//		itemKindXom11.setItemKindName("机动车损失保险无法找到第三方特约险");//非空 码表			
//		// 险别保额
//		itemKindXom11.setAmount("9000000");//可为空
//		// 上年投保是否出险
...
//		itemKindXomList.add(itemKindXom11);
		...
		// 上年赔款总金额
		otherXom.setLastClaimAmount("40000");//可为空
//		// 上年是否有赔案记录
...
//		otherXom.setLastEndDate("2016-12-09");//可为空	
		//无赔优待系数（无赔优NCD系数）
		otherXom.setClaimadjustValue("1");//可为空
		//验车照片数量
		...
		//工作证照片数量
		otherXom.setIdCardPhotosCount("1");
